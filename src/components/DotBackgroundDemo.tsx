...
const chatbots = [
	{
		...
		features: [
			...
			"Try-On feature for outfits on suggestions .",
			"Order tracking & updates .",
			"Live Call and text support .",
			"Lead generation and deep customer's problem Analysis .",
			"Customer query form filling and instant response through email .",
	...
	},
	{
		...
		features: [
			...
			"24/7 Query Handling through Chat and  and order tracking",
