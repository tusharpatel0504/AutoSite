    ...
    <section className="min-h-screen py-20 px-4 sm:px-6 md:px-8 relative overflow-hidden bg-black">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
            ...
            <CardContent className="p-8 sm:p-12">
              <div className="text-center">
                ...
                <div className="space-y-6 text-left max-w-3xl mx-auto">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-8 h-8 bg-black border-2 border-gray-700 rounded-full flex items-center justify-center text-white font-bold">
                      1
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-white mb-2">Automate Your Customer Support</h3>
                      <p className="text-gray-300 text-base">
                        Let AI handle common questions and problems. Your team can focus on harder tasks that need a human touch.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-white mb-2">Reduce Team Costs by 60%</h3>
                      <p className="text-gray-300 text-base">
                        One AI chatbot can do the work of many support staff. Pay less, get more done.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-white mb-2">Save Time for Scaling</h3>
                      <p className="text-gray-300 text-base">
                        Stop wasting time on repetitive tasks. Use that time and money to grow your business bigger and faster.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {values.map((value, index) => (
              <Card key={index} className="border-gray-700 bg-gray-950/90 backdrop-blur-sm hover:bg-gray-900 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  <div className="w-12 h-12 bg-black border-2 border-gray-700 rounded-xl flex items-center justify-center mx-auto mb-4 text-2xl">
                    {value.icon}
                  </div>
        ...
        <div className="mb-20">
          ...
          <p className="text-gray-300 text-center mb-12 text-lg max-w-3xl mx-auto">
            Getting started with Autosite is easy. Here's what happens:
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-black border-2 border-gray-700 rounded-full flex items-center justify-center text-4xl mx-auto mb-4">
                🔍
              </div>
              <h3 className="text-xl font-bold text-white mb-3">We Learn About You</h3>
              <p className="text-gray-400">
                We understand your business, your customers, and what problems you want to solve.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-3">We Build Your AI</h3>
              <p className="text-gray-400">
                We create a smart chatbot customized for your business that talks like your brand.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-3">You See Results</h3>
              <p className="text-gray-400">
                Watch your sales go up, costs go down, and customers get happier.
              </p>
            </div>
          </div>
        </div>
