...
export default function ReplyRates() {
    return (
        <section className="min-h-screen py-12 px-4 flex flex-col items-center relative overflow-hidden">
            <div
                className={cn(
                    ...
                    "[mask-image:linear-gradient(to_bottom,white_0%,transparent_100%)]"
                )}
            />
            {/* Content */}
                ...
                <div className="flex items-center gap-4 mt-8 max-w-2xl text-gray-400">
                    ...
                    <div>
                        ...
                        <div className="text-sm sm:text-base max-w-md">
                            "I personally find the results quite impressive. I only spend a
                            little bit of time to tweak the final copy."
                        </div>
                    </div>
                </div>
            </div>
